...
public class AddTask {
    public static void addTodo (List<Task> array, String message, int itemNumber) {
    ...
    public static void addDeadline(List<Task> array, String message, int itemNumber) {
    ...
    public static void addEvent(List<Task> array, String message, int itemNumber) {
