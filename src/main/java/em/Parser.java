...
import static EmProgram.exception.InvalidUserInputException.*;
...
public class Parser {
     ...
     * @throws InvalidUserInputException If the task number stated does not exist.
     */
     ...
     * @throws InvalidUserInputException If the command type is not valid or description is not inputted.
     */
