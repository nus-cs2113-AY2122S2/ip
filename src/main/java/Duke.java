        ...
        while (!userInput.equalsIgnoreCase("bye")) {
            ...
            if (userInput.equalsIgnoreCase("list")) {
                for (int i = 0; i < taskCount; i += 1) {
                    System.out.println(i + 1 + ".[" + taskList[i].getStatusIcon() + "] " + taskList[i].getTaskDescription());
                }
            }
                ...
                if (taskIndex > taskCount || taskIndex <= 0) {
                    ...
                    System.out.println("[" + taskList[taskIndex - 1].getStatusIcon() + "] " + taskList[taskIndex - 1].getTaskDescription());
                }
            }
